<template>
  <Dropdown :trigger :placement>
    ...
    <template #body>
      <div
        class="bg-bg inline-flex flex-col gap-1 overflow-hidden rounded text-sm leading-none shadow"
      >
        <div v-if="title" class="text-light bg-light px-3 py-2.5">
          {{ title }}
        </div>
        <div
          type="text"
          ...
          :class="[
            ...
            m.divider
              ...
              : 'hover:bg-light-2 flex cursor-pointer items-center gap-1 px-3 py-2 duration-300',
          ]"
        >
